...
<head>
    ...
    <style id="tx-mobile-compact-header-v7105">
    /* v7.10.5 - compact header transaksi mobile, inline agar tidak tertahan cache CSS */
    @media (max-width: 768px) {
        #txPanel .tx-period-bar {
        ...
        #txPanel .tx-period-copy {
            display: block !important;
            flex: 0 0 auto !important;
            min-width: auto !important;
        }
        #txPanel .tx-period-copy b {
            display: block !important;
            font-size: 9px !important;
            line-height: 1 !important;
            margin: 0 !important;
        }
        #txPanel .tx-period-copy small {
            display: none !important;
        }
        #txPanel .tx-period-switch {
        ...
        #txPanel .tx-period-switch button {
        ...
        #txPanel .tx-search-export-row {
            min-height: 40px !important;
            padding: 3px 8px !important;
            margin: 0 !important;
            gap: 6px !important;
        }
        #txPanel .tx-search-box {
            height: 34px !important;
            min-height: 34px !important;
        ...
        #txPanel .tx-search-icon {
            width: 14px !important;
            height: 14px !important;
            flex: 0 0 14px !important;
        }
        #txPanel .tx-search-icon svg {
            width: 14px !important;
            height: 14px !important;
        }
        #txPanel .tx-search-box input {
        ...
        #txPanel .tx-search-box input::placeholder {
            font-size: 10px !important;
        }
        #txPanel .tx-export-toggle {
            height: 34px !important;
            min-height: 34px !important;
    ...
    @media (max-width: 390px) {
        ...
        #txPanel .tx-period-copy b { font-size: 8.5px !important; }
        #txPanel .tx-period-switch {
    ...
    <style id="tx-filter-drawer-mobile-v7107">
        @media (max-width:760px){
            #txPanel .panel-head{padding:13px 16px 11px!important;min-height:auto!important}
            #txPanel .panel-head .panel-subtitle{display:none!important}
            #txPanel .tx-filter-drawer-wrap{padding:7px 12px 6px!important;margin:0!important;background:#fff!important;border-bottom:1px solid #eef1f5!important}
            #txPanel .tx-filter-drawer-toggle{margin:0!important;min-height:42px!important;padding:7px 10px!important;border-radius:13px!important}
            #txPanel .tx-filter-drawer-toggle .tx-filter-toggle-icon{width:30px!important;height:30px!important;min-width:30px!important}
            #txPanel .tx-filter-drawer-label{display:flex!important;flex:1!important;min-width:0!important;flex-direction:column!important;align-items:flex-start!important;gap:1px!important;line-height:1.15!important}
            #txPanel .tx-filter-drawer-label b{font-size:13px!important}
            #txPanel .tx-filter-drawer-label small{font-size:9.5px!important;color:#98a2b3!important;font-weight:500!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;max-width:100%!important}
            #txPanel .tx-filter-drawer-panel{margin-top:7px!important;padding-top:8px!important;border-top:1px solid #eef1f5!important}
            #txPanel .tx-filter-drawer-panel[hidden]{display:none!important}
            #txPanel .tx-filter-drawer-panel:not([hidden]){display:block!important}
            #txPanel .tx-list{padding-top:4px!important}
        }
    </style>
</head>
...
<body<?= ($user && $unlocked) ? ' data-offline-shell="1" data-user-id="' . (int)$user['id'] . '"' : '' ?>>
    ...
    <?php else: db(); ?>
        ...
        <main class="container app-main">
            ...
            <section class="grid">
                ...
                <article class="panel transactions-panel mobile-view" id="txPanel">
                    ...
                    <div class="tx-filter-wrap tx-filter-drawer-wrap">
                        <button type="button" class="tx-filter-toggle tx-filter-drawer-toggle" id="txFilterToggle" aria-expanded="false"
                            ...
                            <span class="tx-filter-drawer-label"><b>Filter transaksi</b><small>Periode, pencarian, unduh & urutkan</small></span>
                            <span class="tx-filter-active-count" id="txFilterActiveCount" hidden>0</span>
                            <span class="tx-filter-chevron">⌄</span>
                        </button>

                        <div class="tx-filter-panel tx-filter-drawer-panel" id="txFilterPanel" hidden>
        ...
        <script>
            ...
            (function() {
                var CACHE_FIX_VERSION = 'finance-cache-fix-v10-5';
                try {
