...
require_once __DIR__.'/../db.php'; require_once __DIR__.'/../finance_features.php';
...
if($_SERVER['REQUEST_METHOD']==='GET'){
    ...
    $payload=['format'=>'pencatatan-keuangan-backup','version'=>3,'username'=>$user['username']??'user','exported_at'=>date('c'),'data'=>$d,'photos'=>$photos,'photos_skipped'=>$skipped];
