    ...
    <dialog id="financeCenter" class="finance-center-dialog">
        <div class="finance-center-card">
            ...
            <div class="finance-tabs" id="financeTabs">
                ...
                <?php if (authIsSuperAdmin($user)): ?><button data-finance-tab="admin">Admin <span
                        class="admin-tab-notification-badge" id="adminTabNotificationBadge"
                        hidden>0</span></button><?php endif; ?>
            </div>
            <div class="finance-content">
                        ...
                        <div class="feature-card">
                            ...
                            <div id="androidInstallArea" hidden>
                                ...
                                <a class="btn primary feature-link-btn" id="downloadAndroidApk"
                                    href="https://catatan-keuangan.cloud/apks/Catatan%20Keuangan-v1.0.0.apk"
                ...
                <?php if (authIsSuperAdmin($user)): ?><section class="finance-tab-panel" data-finance-panel="admin"
                    hidden>
                        ...
                        <div class="admin-broadcast-form">
                            ...
                            <label>Link Tombol (opsional)
                                <input id="adminBroadcastActionUrl" type="url"
                                    placeholder="https://catatan-keuangan.cloud/android-download.php">
                ...
                <div class="device-security-block">
                    ...
                    <div class="device-list" id="loginDeviceList">
                        ...
                        <article class="device-card <?= !empty($device['current']) ? 'current' : '' ?>">
                            ...
                            <div class="device-card-action">
                                ...
                                <?php else: ?>
                                <form method="post"
                                    onsubmit="return confirm('Keluarkan perangkat ini dari akun? Perangkat tersebut harus login kembali.');">
                    ...
                    <div id="loginDeviceRevokeAll" <?= count($loginDevices) > 1 ? '' : 'hidden' ?>>
                        <form method="post" class="device-revoke-all-form"
                            onsubmit="return confirm('Keluarkan SEMUA perangkat lain? Hanya perangkat yang sedang Anda gunakan yang akan tetap login.');">
