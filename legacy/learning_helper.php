...
if(!defined('LEARNING_FILE')) define('LEARNING_FILE','mysql://assistant_learning');
...
function learningEnsureData(){ if(!DocumentRepository::get('assistant','learning',[])) DocumentRepository::put('assistant','learning',learningDefaultData()); }

function learningReadData(){ learningEnsureData(); return array_replace_recursive(learningDefaultData(),DocumentRepository::get('assistant','learning',learningDefaultData())); }

function learningMutateData($fn){ return DocumentRepository::mutate('assistant','learning',learningDefaultData(),function(&$data)use($fn){$data=array_replace_recursive(learningDefaultData(),$data);return call_user_func_array($fn,[&$data]);}); }
